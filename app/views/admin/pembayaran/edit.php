                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="<?= B ?>/pembayaran/edit/pembayaran" method="POST">
                                            <input type="hidden" name="id_pembayaran" value="<?= $data['pembayaran']['id_pembayaran'] ?>">
                                            <div class="form-group my-2">
                                                <label for="tahun_ajaran">Nama pembayaran</label>
                                                <input type="text" name="tahun_ajaran" class="form-control" value="<?= $data['pembayaran']['tahun_ajaran'] ?>">
                                            </div>
                                            <div class="form-group my-2">
                                                <label for="nominal">Nominal</label>
                                                <input type="number" name="nominal" class="form-control" value="<?= $data['pembayaran']['nominal'] ?>">
                                            </div>
